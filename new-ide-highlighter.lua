...
Lib.CodeFrame = (function()
	...
	local function makeFrame(obj)
		...
		frame.BackgroundColor3=Color3.new(0.15686275064945,0.15686275064945,0.15686275064945);frame.BorderSizePixel=0;frame.Position=UDim2.new(0.5,-300,0.5,-200);frame.Size=UDim2.new(0,600,0,400);frame.Visible=true;
		local elems = {}
		...
		scrcfrm.BackgroundColor3=Color3.new(0.15686275064945,0.15686275064945,0.15686275064945);scrcfrm.BorderSizePixel=0;scrcfrm.Name="ScrollCorner";scrcfrm.Position=UDim2.new(1,-16,1,-16);scrcfrm.Size=UDim2.new(0,16,0,16);scrcfrm.Visible=false;
