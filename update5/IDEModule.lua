...
--// UPDATE 5 - Added new functions ClearText, CompileText, and ReturnErrors, changed behavior, removed unnecessary variables and optimized variable use, changed cursor behavior, and fixed general bugs such as current line bolding not matching to what the curent line is.
