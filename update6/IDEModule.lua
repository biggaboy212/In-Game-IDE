...
--[[
	UPDATE 6 
	----
	Tab indent is now replaced by four spaces, due to the 'Tab' unicode not being recognized by roblox. 
	Highlight selections are now translucent (0.5) instead of fully opaque. 
	Changed the syntax colors to not look so cartoony and bright, making it easier on the eyes
]]
	...
	funcs.Refresh = function(self)
		...
		for row = 1,maxLines do
			...
			if not lineFrame then
				...
				selectionHighlight.BackgroundTransparency = 0.5
